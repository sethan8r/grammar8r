...
object Dimens {
    ...
    /**
     * Высота шапки диалога: заголовок с полями сверху и зазором до текста. Ровно на столько тело
     * отступает вниз — как списки экранов отступают под [topBarHeight] (см. `InfoDialog`).
     */
    val dialogHeaderHeight = 72.dp
