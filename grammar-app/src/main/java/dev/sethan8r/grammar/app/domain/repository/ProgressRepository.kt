 ...
 * не перезаписывается; флаги завершения только выставляются и не снимаются.
 */
interface ProgressRepository {

    /**
     * Результат упражнения в момент первого ответа (write-once). Источник правды для зелёного ID и
     * для сводки «верно X из N». На повторном ответе/перезаходе не перезаписывается.
     */
