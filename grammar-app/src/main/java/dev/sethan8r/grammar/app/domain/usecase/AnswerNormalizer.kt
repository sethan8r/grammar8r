 ...
 * схлопывание пробелов. Нормализуем ОБЕ стороны сравнения (и ввод, и принимаемые ответы) — поэтому
 * совпадение работает в любую сторону (автор написал полную форму, юзер ввёл сокращение, и наоборот).
 *
