...
object Durations {
    ...
    /**
     * Подгонка ширины перетаскиваемого чипа под слот, над которым он завис (CATEGORIZATION), мс.
     * Короче [dragReturnMs] — размер успевает устаканиться раньше, чем чип долетит до места.
     */
    const val dragResizeMs = 160
