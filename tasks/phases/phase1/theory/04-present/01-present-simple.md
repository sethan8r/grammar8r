...
**Теги:** настоящее простое, настоящее время, то что происходит вообще, регулярные действия, как сказать о привычном
...
**ID:** 49 | **Order:** 1
**Теги:** не прямо сейчас, чем отличается от продолженного, верно вообще, постоянная реальность
...
**ID:** 50 | **Order:** 2
**Теги:** окончание s у глагола, когда ставить s, он она оно добавляет s, утвердительное предложение
...
**ID:** 51 | **Order:** 3
**Теги:** не делаю, он не делает, нужен помощник для отрицания, отказ от действия
...
**ID:** 52 | **Order:** 4
**Теги:** ты делаешь это, вопросительное предложение, спросить о привычном, задать вопрос
...
**ID:** 53 | **Order:** 5
**Теги:** распорядок дня, факты о себе, постоянные вещи, общие истины
...
**ID:** 54 | **Order:** 6
**Теги:** частота действия, всегда иногда никогда, куда ставить наречие, каждый день и раз в неделю
...
**ID:** 55 | **Order:** 7
**Теги:** надо сделать, вынужден делать, обязанность, приходится по обстоятельствам
...
## Microtopic 56 — Live Practice · Закрепление Present Simple с ИИ
...
Задания опираются на твою базу из «Основ»: предлоги (in, on, at, to, for…), вопросительные слова (what, why, where, when, how), местоимения. Если споткнулся на слове — это сигнал повторить слова в словаре: лексика живёт и закрепляется именно там, а карточки теории — про правила, не про заучивание слов.
...
**Prompt Template:** "Дай пользователю ТРИ коротких простых английских предложения в Present Simple, пронумерованных 1, 2, 3, — из простой повседневной лексики. Часть предложений сделай с типичными ошибками русскоязычных, а часть оставь полностью правильными; случайно меняй от запуска к запуску, сколько предложений с ошибкой и какие именно это номера — иногда ошибка в одном, иногда в двух, иногда во всех трёх. Ошибки бери из этого набора: пропавший -s в третьем лице (he work); «am working» вместо «work»; лишний -s после doesn't (doesn't works); лишний -s после does в вопросе (Does she works?); don't вместо doesn't (He don't like). Смешивай утверждения, отрицания и вопросы; каждый запуск — другие предложения и другой набор ошибок, не повторяйся. Попроси найти предложения с ошибкой и переписать их правильно, а верные оставить как есть. Проверь ответ: по каждой настоящей ошибке кратко покажи, что было не так, дай верный вариант и в одном-двух предложениях объясни правило по-русски, чтобы запомнилось. Если пользователь «исправил» предложение, которое и так было верным, обязательно скажи об этом и объясни, почему там всё в порядке. Если он пропустил ошибку — покажи её. Не придирайся к знакам препинания и заглавным буквам — оценивай только грамматику."

Пример вывода AI: 'Найдите ошибки и перепишите такие предложения правильно: 1. My friend work in a bank. 2. Kate doesn't drink coffee in the evening. 3. Does he goes to work by bus?'
