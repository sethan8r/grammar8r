...
**Таблица счётчиков** (актуально после MT7 Card 53 + MT17 Card 52 + микротем 18–20):

| Тип | Последний ID | Следующий |
|-----|-------------|-----------|
| WordArrangement | 36 | 37 |
| MultipleChoice · CHOICE | 55 | 56 |
| MultipleChoice · FORWARD_CHOICE | 52 | 53 |
| MultipleChoice · REVERSE_CHOICE | 14 | 15 |
| TrueFalse | 35 | 36 |
| ErrorCorrection | 31 | 32 |
| TextInput | 21 | 22 |
| Matching | 8 | 9 |
| Transformation | 7 | 8 |
| Categorization | 8 | 9 |
