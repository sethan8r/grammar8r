...
| # | Предложение | Верно? |
|---|-------------|--------|
| 1 | Yes, they are. | ✓ верно |
| 2 | Yes, they're. | ✗ неверно |
| 3 | Yes, she is. | ✓ верно |
| 4 | Yes, she's. | ✗ неверно |
| 5 | Yes, I am. | ✓ верно |
...
AI описывает ситуацию по-русски (например: "Ты в ресторане. Официант подходит. Скажи ему, что хочешь посмотреть меню."). Задача: написать предложение с правильным артиклем. AI проверяет и объясняет — почему здесь the, а не a.

/да, только дать еще слова надо, ибо пользователь может их не знать, либо заготовку предложения где надо расставить артикль, если даем заготовку, то надо дать и перевод. Или даем предложение на месте пропусков ставим (1) (2) (3), значит на таком месте должен стоять артикль в ответе, ответ типа a the an, понял идеюю?/
