...
**Prompt Template:** "Дай описание человека или предмета по-русски с пропуском на личное местоимение (например: 'Твоя подруга Лена учится на врача. ___ очень умная.'). Слова-подсказки не нужны — контекст ясен. Проверь выбор и объясни ошибку: почему именно he/she/it/they."
