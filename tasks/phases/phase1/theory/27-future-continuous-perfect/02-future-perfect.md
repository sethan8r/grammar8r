...
- **Скажи по-английски.** Русская фраза с признаком в самой ситуации: срок, «когда ты приедешь», «успеешь?», итог к дате, «будет N лет, как», прогноз, догадка, пересказ. Во всех фразах работает Future Perfect; где срок задан словом `by`, засчитывается и простое `will`.
