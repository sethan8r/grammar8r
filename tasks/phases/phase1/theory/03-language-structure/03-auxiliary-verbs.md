# 4 Auxiliary Verbs · Служебные глаголы
...
**Описание:** do, be, have, will — слова-сигналы грамматики: они строят вопросы, отрицания, времена и залог, но не переводятся напрямую
**Теги:** вспомогательные глаголы, глаголы-помощники, do be have will, слова-сигналы грамматики, как строятся вопросы и отрицания
**Группа слов:** language_structure · Устройство языка
**Категория слов:** language_structure · Language Structure · source=course_words
**Слова курса — стартовый ID:** 289

> **Категория слов:** все слова темы «Служебные глаголы» при открытии попадают в категорию **"Language Structure"** (раздел «Слова курса» → «Устройство языка»).
...
## Microtopic 36 — do / does / did · Сигнал вопроса и отрицания

**ID:** 36 | **Order:** 1
**Теги:** do или does, did для прошлого, поставить вопрос глаголом, сделать отрицание do, doesn't и don't разница

---

### Card 100 · do и does: маркер вопроса

**ID:** 100 | **Order:** 1

#### Theory

В Основах мы уже встречали do и does — они появлялись в конструкции с глаголом have: Do you have a pen? и Does she have a job?. Теперь главное открытие: **do и does работают с любым глаголом**, не только с have.

Английский не строит вопросы через интонацию — он выносит вспомогательный глагол **do** или **does** перед подлежащим:

**Формула вопроса:**

| Форма | Для кого | Пример | Перевод |
|-------|----------|--------|---------|
| **do** | I, you, we, they | Do you work here? | Ты работаешь здесь? |
| **does** | he, she, it | Does she speak English? | Она говорит по-английски? |

После do/does глагол всегда в **базовой форме** — без окончаний:

*Does Dima like football?* *(Дима любит футбол?)* — не `likes`.
*Do they understand the question?* *(Они понимают вопрос?)* — просто `understand`.

**Ловушка 1:** Work you here? ✗ — в английском нельзя поставить глагол вперёд, как иногда делают по аналогии с немецким. Нужен маркер: Do you work here? ✓

**Ловушка 2:** Does she likes coffee? ✗ — does уже отвечает за 3-е лицо. Глагол остаётся в базовой форме: Does she like coffee? ✓

#### Summary *(кнопка «?» в упражнениях)*

Вопрос строится через do (I/you/we/they) или does (he/she/it), который встаёт перед подлежащим. После do/does — глагол в базовой форме. Does she like (не `likes`), Do they know (не `knows`).

#### Examples

| # | RU | EN |
|---|----|----|
| 459 | Ты работаешь по выходным? | Do you work on weekends? |
| 460 | Рома любит кофе? | Does Roma like coffee? |
| 461 | Они понимают задание? | Do they understand the task? |

---

#### Exercises

**Ex 1 · MultipleChoice · CHOICE** *(ID: 70)*

"___ she speak Spanish?" *(Она говорит по-испански?)*

- Do
- **Does** ✓
- Did

*Explanation:* She — 3-е лицо единственного числа (he/she/it). Для he/she/it в вопросе — does. Do — для I/you/we/they. Did — маркер прошедшего.

---

**Ex 2 · MultipleChoice · FORWARD_CHOICE** *(ID: 63)*

"Они живут в Москве?"

- Does they live in Moscow?
- They live in Moscow?
- **Do they live in Moscow?** ✓

*Explanation:* They — множественное число, группа I/you/we/they → do. «Does they» — ошибка: does только для he/she/it. «They live in Moscow?» — вопрос без do/does в английском невозможен.

---

**Ex 3 · TrueFalse** *(ID: 48)*

| # | EN | RU | Верно? |
|---|----|----|--------|
| 1 | Do you work on weekdays? | Ты работаешь в будни? | ✓ |
| 2 | Does she likes basketball? | Она любит баскетбол? | ✗ |
| 3 | Work they in this office? | Они работают в этом офисе? | ✗ |
| 4 | Does Kolya know the answer? | Коля знает ответ? | ✓ |
| 5 | Do we need tickets? | Нам нужны билеты? | ✓ |

*Explanation:* 2: does + базовая форма → «like» (не «likes»). 3: нельзя начинать вопрос с основного глагола — нужен маркер: «Do they work...?». 1, 4, 5 — правильные формы.

---

**Ex 4 · WordArrangement** *(ID: 47)*

RU: Рома любит кофе?

Правильное предложение: **Does Roma like coffee?**
...
*Explanation:* Roma — он, 3-е лицо → Does. После does — базовая форма «like» (не «likes»). «Do» — дистрактор: подходит для I/you/we/they, но не для Roma.

---

#### AI Exercise

**ID:** auxiliary_card100_ex1
**Title:** "Вопрос с do или does"
**Input Mode:** FREE_WRITE
**Words Source:** GENERAL
**AI Config Profile:** EXERCISE_LIGHT
**User Instruction:** "Составь вопрос на английском к ситуации, которую я дам."
**Prompt Template:** "Дай пользователю короткую ситуацию на русском — кто-то что-то делает (1–2 предложения). Попроси составить вопрос на английском с do или does. Проверь: правильная ли форма (do/does по субъекту), глагол в базовой форме после does. При ошибке — поправь и объясни по-русски кратко. Если в присланном списке слов найдутся подходящие глаголы — желательно строить ситуации вокруг них, но фокус задания на структуре вопроса с do/does, а не на конкретной лексике."

Пример вывода AI: 'Твоя подруга Саша — учитель. Она преподаёт математику в школе. Составь вопрос: ты хочешь спросить, нравится ли ей её работа.'

#### Clarification Options

- Почему после does глагол без -s, если does уже отвечает за 3-е лицо?
- Можно ли задать вопрос просто интонацией, без do/does — как в русском?
- Do или does — как быстро понять, какой нужен?

---

### Card 101 · don't и doesn't: маркер отрицания

**ID:** 101 | **Order:** 2

#### Theory

Мы помним из Основ: I don't have и She doesn't have. Та же система работает с **любым** глаголом.

Отрицание строится не через окончание глагола, а через отдельные слова **don't** и **doesn't**:

| Форма | Для кого | Расшифровка |
|-------|----------|-------------|
| **don't** | I, you, we, they | do + not |
| **doesn't** | he, she, it | does + not |

После doesn't глагол всегда в **базовой форме** — так же, как после does в вопросе:

*She doesn't work here.* *(Она не работает здесь.)* — не `works`.
*They don't understand.* *(Они не понимают.)* — просто `understand`.

**Ловушка 1:** She not work. ✗ — нельзя вставить not прямо перед глаголом. Нужен doesn't: She doesn't work. ✓

**Ловушка 2:** She doesn't works. ✗ — doesn't уже несёт форму 3-го лица. Глагол не получает -s: She doesn't work. ✓

**Кстати:** полные формы `do not` и `does not` используются в официальных текстах или для особого акцента: *I do not agree.* *(Я категорически не согласен.)*

#### Summary *(кнопка «?» в упражнениях)*

Отрицание: don't (I/you/we/they) или doesn't (he/she/it) + глагол в базовой форме. She doesn't work (не `works`, не She not work). don't = do + not, doesn't = does + not.

#### Examples

| # | RU | EN |
|---|----|----|
| 462 | Я не понимаю это правило. | I don't understand this rule. |
| 463 | Катя не работает по субботам. | Katya doesn't work on Saturdays. |
| 464 | Они не знают её адрес. | They don't know her address. |

---

#### Exercises

**Ex 5 · ErrorCorrection** *(ID: 45)*

"Igor not work today."

- Igor not works today.
- Igor no work today.
- **Igor doesn't work today.** ✓

*Explanation:* Отрицание строится только через don't/doesn't — нельзя вставить «not» или «no» прямо перед основным глаголом. Igor = he → doesn't. После doesn't — базовая форма «work».

---

**Ex 6 · MultipleChoice · FORWARD_CHOICE** *(ID: 64)*

"Лена не знает ответ."

- Lena not know the answer.
- Lena doesn't knows the answer.
- **Lena doesn't know the answer.** ✓

*Explanation:* Lena = she → doesn't. После doesn't — базовая форма «know» (не «knows»). «Lena not know» — нет doesn't, так нельзя строить отрицание.

---

**Ex 7 · Transformation** *(ID: 14)*

Задание: Преобразуй утвердительные предложения в отрицательные

1. "Vera works in a café." → **"Vera doesn't work in a café."**
2. "They speak Spanish." → **"They don't speak Spanish."**
3. "Tema likes action films." → **"Tema doesn't like action films."**

*Explanation:* Vera, Tema = he/she → doesn't + базовая форма (work, like — без -s). They → don't + базовая форма (speak). В отрицании -s убирается с глагола: «works» → «doesn't work».

---

**Ex 8 · TextInput** *(ID: 30)*

Вставь don't или doesn't:

1. "I ___ understand this question." (Я не понимаю этот вопрос.)
   Ответ: **don't**
2. "She ___ work on weekends." (Она не работает по выходным.)
   Ответ: **doesn't**
3. "We ___ know his phone number." (Мы не знаем его номер телефона.)
   Ответ: **don't**
4. "He ___ like cold weather." (Ему не нравится холодная погода.)
   Ответ: **doesn't**

*Explanation:* I/we → don't. She/He → doesn't. Правило: don't для I/you/we/they, doesn't для he/she/it.

---

#### AI Exercise

**ID:** auxiliary_card101_ex1
**Title:** "Отрицание с don't / doesn't"
**Input Mode:** FREE_WRITE
**Words Source:** GENERAL
**AI Config Profile:** EXERCISE_LIGHT
**User Instruction:** "Преобразуй утвердительное предложение в отрицательное."
**Prompt Template:** "Дай пользователю утвердительное предложение на английском с обычным глаголом (не to be). Попроси написать его в отрицательной форме с don't / doesn't. Проверь: правильную форму (don't/doesn't по субъекту) и базовую форму глагола после doesn't. При ошибке — поправь и объясни по-русски кратко. Если в присланном списке слов найдутся подходящие глаголы — желательно строить предложения вокруг них, но фокус задания на структуре отрицания с don't/doesn't, а не на конкретной лексике."

Пример вывода AI: 'Dima works at a bank. Напиши это предложение в отрицательной форме.'

#### Clarification Options

- Чем don't отличается от doesn't — когда какой?
- Почему после doesn't глагол без -s, если речь про she/he/it?
- Можно ли сказать «She not works» или «She is not working» — это одно и то же?

---

### Card 102 · does и did: форма меняется, роль та же

**ID:** 102 | **Order:** 3

#### Theory

do, does, did — три формы одного маркера. Роль всегда одна: сигнал вопроса или отрицания. Меняется только форма — в зависимости от субъекта и времени.

**В настоящем** — форма зависит от субъекта:

| Субъект | Форма | Вопрос | Отрицание |
|---------|-------|--------|-----------|
| I, you, we, they | **do** | Do they work? | They don't work. |
| he, she, it | **does** | Does she work? | She doesn't work. |

**В прошлом** — одна форма для всех субъектов:

| Субъект | Форма | Вопрос | Отрицание |
|---------|-------|--------|-----------|
| все | **did** | Did she work? | She didn't work. |

*didn't = did + not*

После **did** глагол всегда в **базовой форме** — did уже несёт прошедшее время:

*Did Katya come to the party?* *(Катя пришла на вечеринку?)* — не `came`.
*He didn't know.* *(Он не знал.)* — не `knowed` (такой формы в английском вообще нет).

**Ловушка:** Did she worked? ✗ → Did she work? ✓ — did уже означает прошлое. Второй раз обозначать его через форму глагола не нужно — это двойное прошлое, которого в английском не бывает.

#### Summary *(кнопка «?» в упражнениях)*

Настоящее: do (I/you/we/they) / does (he/she/it). Прошлое: did — для всех субъектов без исключений. После did — глагол в базовой форме: Did she work? (не `worked`), I didn't know (не `knowed`).

#### Examples

| # | RU | EN |
|---|----|----|
| 465 | Она вчера закончила работу? | Did she finish work yesterday? |
| 466 | Они не поняли задание. | They didn't understand the task. |
| 467 | Игорь работает в банке? | Does Igor work at a bank? |

---

#### Exercises

**Ex 9 · MultipleChoice · CHOICE** *(ID: 71)*

"___ Katya come to the party last night?" *(Катя вчера вечером пришла на вечеринку?)*

- Do
- Does
- **Did** ✓

*Explanation:* «last night» — вчера вечером, это прошлое время. Для прошлого — did, независимо от субъекта. Do — настоящее для I/you/we/they. Does — настоящее для he/she/it.

---

**Ex 10 · Matching** *(ID: 17)*

Задание: Соедини русское предложение с английским

| Русское | Английское |
|---------|------------|
| Она знает ответ? | Does she know the answer? |
| Коля вчера пришёл? | Did Kolya come yesterday? |
| Они работают здесь? | Do they work here? |
| Тёма вчера не пришёл. | Tema didn't come yesterday. |
| Вера знает твой адрес? | Does Vera know your address? |

*Explanation:* Настоящее + she/Vera → Does. Настоящее + they → Do. Прошлое → did/didn't для любого субъекта. После did/didn't — базовая форма: «come» (не «came»).

---

**Ex 11 · TrueFalse** *(ID: 49)*

| # | EN | RU | Верно? |
|---|----|----|--------|
| 1 | Did she finish the report? | Она закончила отчёт? | ✓ |
| 2 | He did works yesterday. | Он работал вчера. | ✗ |
| 3 | Did they understand the question? | Они поняли вопрос? | ✓ |
| 4 | Did Lena comed to the party? | Лена пришла на вечеринку? | ✗ |
| 5 | I didn't see him last week. | Я не видел его на прошлой неделе. | ✓ |

*Explanation:* 2: после did — базовая форма «work» (не «works»). 4: «comed» не существует, базовая форма от to come — просто «come»: «Did Lena come to the party?». 1, 3, 5 — правильные.

---

**Ex 12 · MultipleChoice · FORWARD_CHOICE** *(ID: 65)*
...
*Explanation:* Прошлое время → did. После did — базовая форма «work» (не «worked»: did уже отвечает за прошлое). «You worked yesterday?» — вопрос без did в английском невозможен.

---

#### AI Exercise

**ID:** auxiliary_card102_ex1
**Title:** "Вопрос и отрицание с did"
**Input Mode:** FREE_WRITE
**Words Source:** GENERAL
**AI Config Profile:** EXERCISE_LIGHT
**User Instruction:** "Составь вопрос или отрицание о прошедшем событии."
**Prompt Template:** "Дай пользователю ситуацию в прошлом на русском — что кто-то делал или не делал вчера или на прошлой неделе. Попроси составить вопрос с did или отрицание с didn't на английском. Проверь: форму did/didn't и глагол в базовой форме (не прошедшее время). При ошибке — поправь и объясни по-русски кратко. Если в присланном списке слов найдутся подходящие глаголы — желательно строить ситуации вокруг них, но фокус задания на структуре с did/didn't, а не на конкретной лексике."

Пример вывода AI: 'Оля должна была позвонить Игорю вчера, но не сделала этого. Составь отрицательное предложение на английском.'

#### Clarification Options

- Почему после did нельзя ставить глагол в прошедшем времени?
- did используется только в вопросах или тоже в отрицаниях?
- Как отличить did-вспомогательный от did основного: «I did it» — это одно и то же did?
...
**ID:** 39 | **Order:** 2
**Теги:** три роли be, be связка или сигнал, was и were разница, be перед v-ing, be перед v3
...
**ID:** 40 | **Order:** 3
**Теги:** иметь или уже сделал, have has had разница, had в прошлом без исключений, have has плюс v3
...
**ID:** 41 | **Order:** 4
**Теги:** will как служебный сигнал, will плюс v-ing превью, will плюс v3 превью, will не значит хотеть
