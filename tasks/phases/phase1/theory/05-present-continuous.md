...
**Prompt Template:** "Сгенерируй пользователю короткий текст (2–3 предложения) в Present Continuous, построенный ТОЛЬКО из слов присланного списка его слов (можно добавлять лишь базовые общеизвестные слова — cat, dog, house, home, table…), намеренно вставив типичные ошибки русскоязычных: пропавшая связка be (I working вместо I am working), do/does вместо be (I don't working, Does she working?), забытый -ing (She is cook), глагол-состояние в Continuous (I am knowing, She is wanting вместо I know, She wants), кривое написание -ing (writeing, runing, comeing). По возможности задействуй разные ситуации Present Continuous (сейчас / временная / план на будущее / привычка с always) и смешивай утверждения, отрицания и вопросы; каждый запуск — другие слова и другой набор ошибок, не повторяйся. Попроси переписать текст правильно. По каждой ошибке кратко покажи, что было не так, дай верный вариант и в одном-двух предложениях объясни правило по-русски, чтобы запомнилось. Не придирайся к знакам препинания и заглавным буквам — оценивай только грамматику."

Пример вывода AI: 'Исправьте ошибки: My sister cooking dinner now. I am wanting to help her. Does the baby sleeping?'
