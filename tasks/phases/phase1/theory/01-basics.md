...
**Примечание:** есть ещё `below` — «ниже» в переносном смысле (below average — ниже среднего). Про физическое положение предметов говорят `under`, и в Основах нам хватит его одного.
...
**Примечание:** у `by` есть и другие роли — **by car** (на чём едешь), **a book by Tolstoy** (кем сделано). Их разберём отдельно, здесь нас интересует только значение места.
