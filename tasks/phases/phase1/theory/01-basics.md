...
**Prompt Template:** "Дай описание человека или предмета по-русски с пропуском [___] на личное местоимение (например: 'Твоя подруга Лена учится на врача. [___] очень умная.'). Слова-подсказки не нужны — контекст ясен. Проверь выбор и объясни ошибку: почему именно he/she/it/they."

Пример вывода AI: 'Твой друг Игорь работает в офисе. [___] очень занятой.'
...
Пример вывода AI: 'Переведи на английский: «Рома — учитель.» Слова-подсказки: teacher.'
...
Пример вывода AI: 'Перепиши в отрицательной форме: "They are at the cinema." (Они в кино.)'
...
Пример вывода AI: 'Составь предложение из набора: «she / a green bicycle».'
...
Пример вывода AI: 'Составь вопрос на английском: «У твоего брата есть собака?» Слова-подсказки: brother, dog.'
...
Пример вывода AI: '1. яблоко — [___] apple. 2. вода — [___] water. 3. совет — [___] advice.'
...
Пример вывода AI: '1. [___] honest mistake. 2. [___] European country. 3. [___] hour of waiting.'
...
Пример вывода AI: '[___] sun rises in [___] east. (Солнце встаёт на востоке.)'
