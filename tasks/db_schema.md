...
>   «Погода», «Глагол have — нестандартные употребления». Отдельные категории на каждую такую тему
>   не заводим — это строки по 15–20 слов, которые только дробят Словарь.
>
