...
data class IrregularVerb(
    ...
    // ⚠️ ХВОСТ (id 119–198, редкое/книжное/производное) = 181 (МТ «Live Practice ·
    //    Past Perfect Continuous») — правка 30.08.2026, раньше здесь стояло «все 198
    //    разом на 44». Хвост открывается ПОЗЖЕ, отдельным событием: в Card 474 юзеру
    //    текстом обещано, что основная колода закрыта, а остальные глаголы открываются
    //    как необязательный добор «по желанию». До Card 474 глаголы id 119+ в колоде
