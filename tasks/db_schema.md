...
Кстати / Важно / Не путай / Формула / …) → `callout` — в любой из трёх форм, в том числе когда
**вся строка в болде**. Строка целиком в болде БЕЗ ключевого слова → `heading`. Подробно с
примерами — `theory_content_guide.md` §8.
