...
/**
 * Строит [SearchIndex] из настоящей content.db — собранной из тех же сидов и Room-схемы, что и БД
 * в APK (путь передаёт Gradle, БД пересобирается перед прогоном тестов).
 *
